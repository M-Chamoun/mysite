 ...
 echo '
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <h2 class="text-success font-weight-bold">'. $row[1] .'</h2>
          <p class="text-dark font-weight-bold">'.$row[2].'</p>
          <hr>
        </div>
        <div class="col-lg-4 ">
<form action="onepage.php" method="post">
 <input type="submit" value="submit" name="sub" style="padding:10px 20px;margin-top:40px">
 <input type="text" name="hidden_id" value='. $row[0] .' class=" d-none" style="/*display:none*/">
